    ...
    <section class="hero-section">
      <div class="container hero-grid reveal active">
        <div style="text-align: left;">
          <span style="color: var(--primary); font-weight: 800; letter-spacing: 0.2em; display: inline-block; margin-bottom: 1.5rem; text-transform: uppercase;">Academic Excellence</span>
          <h1 style="font-size: 5rem; margin-bottom: 2rem; line-height: 1.1; color: var(--primary-dark);">English for <span style="color: var(--primary);">Researchers</span></h1>
        ...
        <div class="hero-image-container">
          <img src="/assets/img/capa/ENG RESEARCHERS.webp" alt="English for Researchers">
        </div>
      </div>
    </section>
