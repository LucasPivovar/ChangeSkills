...
import { ArrowLeft, ArrowRight, Check, TrendingUp, Lightbulb, Target } from '@lucide/vue'
  ...
  <div class="modality-detail-view">
    ...
    <!-- Hero Section -->
        <section style="position: relative; padding: 220px 0 150px 0; min-height: 90vh; display: flex; align-items: center; overflow: hidden; background: #001233;">
            <img src="https://changeskills.com.br/wp-content/uploads/2025/11/Adult-1.png" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: 0; opacity: 0.5;">
            ...
            <div class="container" style="position: relative; z-index: 2;">
                <div class="reveal active" style="max-width: 850px; text-align: left;">
                    <span style="color: var(--accent); font-weight: 800; letter-spacing: 0.3em; text-transform: uppercase; margin-bottom: 1.5rem; display: block;">Standard of Excellence</span>
                    <h1 style="font-size: 5rem; color: white; margin-bottom: 2rem; line-height: 1.1; font-weight: 800;">Adult <span style="color: var(--accent);">Excellence</span></h1>
                    <p style="font-size: 1.4rem; color: rgba(255,255,255,0.9); margin-bottom: 3.5rem; line-height: 1.6; font-weight: 300;">
                        Alcance a fluência definitiva com o curso mais completo da Change Skills. Utilizando o renomado material <strong>Roadmap</strong> da Pearson, cobrimos do nível <strong>A1 ao C1</strong> com profundidade e excelência.
                    </p>
            ...
            <div class="container">
                <div class="reveal" style="margin-bottom: 6rem; text-align: left;">
                    ...
                    <p style="max-width: 900px; margin: 2rem 0; color: var(--gray); font-size: 1.25rem; line-height: 1.8;">
                        O <strong>Excellence</strong> é ideal para adultos que buscam dominar o idioma com consistência. O material <strong>Roadmap</strong> oferece uma jornada estruturada, consolidando gramática, vocabulário e conversação em todos os níveis.
                    </p>
                </div>
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
                    <div class="feature-card reveal">
                        <TrendingUp style="color: var(--primary); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.6rem; margin-bottom: 1rem;">Evolução Progressiva</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Estrutura organizada em 8 níveis que permitem acompanhar seu progresso e alcançar resultados reais com segurança.</p>
                    </div>
                    <div class="feature-card reveal">
                        <Lightbulb style="color: var(--accent); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.6rem; margin-bottom: 1rem;">Conteúdos Autênticos</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Baseado em temas atuais, vídeos e discussões práticas, o curso amplia seu repertório cultural e linguístico.</p>
                    </div>
                    <div class="feature-card reveal">
                        <Target style="color: var(--primary); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.6rem; margin-bottom: 1rem;">Fluência e Precisão</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Atividades que combinam conversação, leitura e escrita com feedback contínuo para uma comunicação impecável.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="materiais" style="padding: 120px 0;">
            <div class="container">
                <div class="reveal" style="margin-bottom: 6rem; text-align: left;">
                    ...
                    <h2 style="margin-top: 1rem; font-size: 3.5rem; color: var(--primary-dark);">Roadmap (Pearson)</h2>
                    <p style="max-width: 900px; margin: 2rem 0; color: var(--gray); font-size: 1.2rem; line-height: 1.8;">
                        O <strong>Roadmap</strong> é uma jornada de aprendizado completa, dividida em <strong>8 níveis (A1 a C1)</strong>, permitindo uma progressão contínua, personalizada e de alta performance.
                    </p>
                </div>
                <div class="swiper material-swiper reveal">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/814-f63ChVL._AC_UF10001000_QL80_.jpg" alt="A1">
                            <h4>Nível A1</h4>
                        </div></div>
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/81thvkkpQiL._AC_UF10001000_QL80_.jpg" alt="A2">
                            <h4>Nível A2</h4>
                        </div></div>
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/81dgQw8-yoL._AC_UF10001000_QL80_.jpg" alt="A2+">
                            <h4>Nível A2+</h4>
                        </div></div>
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/817RM6TtZaL._AC_UF10001000_QL80_.jpg" alt="B1">
                            <h4>Nível B1</h4>
                        </div></div>
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/81dKIq27E0L._AC_UF10001000_QL80_.jpg" alt="B1+">
                            <h4>Nível B1+</h4>
                        </div></div>
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/81wA5uQynCL._AC_UF10001000_QL80_.jpg" alt="B2">
                            <h4>Nível B2</h4>
                        </div></div>
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/81-MnLA1GL._AC_UF10001000_QL80_.jpg" alt="B2+">
                            <h4>Nível B2+</h4>
                        </div></div>
                        <div class="swiper-slide"><div class="material-item">
                            <img src="https://changeskills.com.br/wp-content/uploads/2025/10/81vNAoy6LL._AC_UF10001000_QL80_.jpg" alt="C1-C2">
                            <h4>Nível C1-C2</h4>
                        </div></div>
                    </div>
        ...
        <section style="padding: 120px 0; background: #001233; color: white;">
            <div class="container">
                <div style="text-align: center; margin-bottom: 60px;" class="reveal">
                    <h2 style="font-size: 3rem; color: var(--accent);">Jornada de Excelência</h2>
                    <p style="opacity: 0.8; font-size: 1.2rem; margin-top: 1rem;">Estrutura completa para o seu domínio total do inglês</p>
                </div>
                <div class="grid-niveis">
                    <div class="glass-card reveal" style="padding: 3rem; background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1);">
                        <h3 style="color: var(--accent); font-size: 1.8rem; margin-bottom: 1rem;">Fundamentos (A1-A2)</h3>
                        <p style="opacity: 0.8; line-height: 1.7;">Domínio das estruturas básicas, rotinas e comunicação essencial para o dia a dia e situações reais.</p>
                    </div>
                    <div class="glass-card reveal" style="padding: 3rem; background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1);">
                        <h3 style="color: var(--accent); font-size: 1.8rem; margin-bottom: 1rem;">Intermediário (A2+-B1)</h3>
                        <p style="opacity: 0.8; line-height: 1.7;">Expansão de vocabulário e fluência funcional, permitindo interações mais complexas e seguras.</p>
                    </div>
                    <div class="glass-card reveal" style="padding: 3rem; background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1);">
                        <h3 style="color: var(--accent); font-size: 1.8rem; margin-bottom: 1rem;">Avançado (B1+-B2)</h3>
                        <p style="opacity: 0.8; line-height: 1.7;">Domínio da conversação em temas variados, produção de textos e compreensão de contextos culturais diversos.</p>
                    </div>
                    <div class="glass-card reveal" style="padding: 3rem; background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1);">
                        <h3 style="color: var(--accent); font-size: 1.8rem; margin-bottom: 1rem;">Mastery (B2+-C1)</h3>
                        <p style="opacity: 0.8; line-height: 1.7;">Precisão linguística e comunicação estratégica para uso profissional, acadêmico e certificações internacionais.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div style="display: grid; gap: 2rem;">
                    ...
                    <div class="level-card reveal">
                        ...
                        <div class="level-title">Conversação Avançada</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Imersão total na fala ativa de alto nível, explorando expressões idiomáticas contemporâneas, modulações de voz e ritmo natural de nativos.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Expressões Idiomáticas</span>
                            <span class="topic-tag">Pronúncia e Ritmo</span>
                            <span class="topic-tag">Atualidades</span>
                            <span class="topic-tag">Debates</span>
                        </div>
                    </div>

                    <div class="level-card reveal">
                        <div class="level-number">Nível 2</div>
                        <div class="level-title">Imersão Cultural</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Compreensão profunda dos aspectos culturais e nuances sociais dos falantes nativos, incluindo humor refinado, referências literárias e mídia de alta complexidade.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Literatura</span>
                            <span class="topic-tag">Humor</span>
                            <span class="topic-tag">Nuances Sociais</span>
                            <span class="topic-tag">Escuta Avançada</span>
