        ...
        <section class="hero-section">
            <div class="container hero-grid reveal active">
                <div style="text-align: left;">
                    <span style="color: var(--primary); font-weight: 800; letter-spacing: 0.2em; display: inline-block; margin-bottom: 1.5rem; text-transform: uppercase;">🇪🇸 Espanhol para Jovens</span>
                    <h1 style="font-size: 4.5rem; margin-bottom: 2rem; line-height: 1.1; color: var(--primary-dark);">Espanhol para <span style="color: var(--primary);">Jovens</span></h1>
                    <p style="font-size: 1.3rem; color: var(--primary-dark); font-weight: 600; margin-bottom: 1.5rem;">
                        Aprendizado Dinâmico, Interativo e Comunicativo
                    </p>
                    <p style="font-size: 1.1rem; color: var(--gray); margin-bottom: 3rem; line-height: 1.8; max-width: 600px;">
                        Na <strong>Change Skills</strong>, os jovens aprendem espanhol de forma leve, divertida e eficiente, estimulando a comunicação natural através de atividades interativas e situações reais. Utilizamos o material <strong>Compañeros</strong>, amplamente reconhecido no ensino de espanhol para jovens ao redor do mundo.
                    </p>
                ...
                <div class="hero-image-container">
                    <img src="/assets/img/espanol card1.jpeg" alt="Espanhol para Jovens — Change Skills">
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="reveal" style="margin-bottom: 5rem; text-align: left;">
                    ...
                    <p style="max-width: 800px; margin: 2rem 0; color: var(--gray); font-size: 1.15rem; line-height: 1.8;">
                        O programa para jovens foi desenvolvido para tornar o espanhol presente no cotidiano do aluno desde o início, estimulando a participação ativa e a comunicação natural, com atividades interativas, projetos, conversação e situações reais.
                    </p>
                </div>
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
                    <div class="feature-card reveal">
                        ...
                        <p style="color: var(--gray); line-height: 1.6;">Foco em situações que os jovens realmente vivem — redes sociais, música, viagens e cultura hispânica.</p>
                    </div>
                    <div class="feature-card reveal">
                        ...
                        <p style="color: var(--gray); line-height: 1.6;">Atividades dinâmicas e colaborativas com forte contextualização no universo hispânico contemporâneo.</p>
                    </div>
                    <div class="feature-card reveal">
                        ...
                        <p style="color: var(--gray); line-height: 1.6;">Desenvolvimento progressivo das habilidades com conteúdo moderno, motivador e altamente comunicativo.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section style="padding: 100px 0; background: white;" id="material">
            <div class="container reveal">
                <div style="text-align: left; margin-bottom: 5rem;">
                    ...
                    <h2 style="margin-top: 1rem; font-size: 3rem; color: var(--primary-dark);">Compañeros</h2>
                    <p style="max-width: 900px; margin: 2rem 0; color: var(--gray); font-size: 1.15rem; line-height: 1.8;">
                        A linha <strong>Compañeros</strong> oferece aprendizado comunicativo, conteúdo moderno e interativo, forte contextualização cultural e desenvolvimento integrado das habilidades, com atividades dinâmicas e motivadoras em 4 volumes para uma jornada completa no espanhol.
                    </p>
                </div>
                <div class="material-grid">
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros-20260521T142910Z-3-001/Livros/WhatsApp Image 2026-05-19 at 17.06.09.jpeg" alt="Compañeros 1">
                        <span class="nivel-badge">Nível 1 — A1</span>
                        <h4>Compañeros 1</h4>
                        <p>Primeiros Contatos. Vocabulário básico e comunicação simples do cotidiano.</p>
                    </div>
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros-20260521T142910Z-3-001/Livros/companhero2.jpeg" alt="Compañeros 2">
                        <span class="nivel-badge">Nível 2 — A2</span>
                        <h4>Compañeros 2</h4>
                        <p>Expansão da Comunicação. Diálogos completos e maior confiança ao falar.</p>
                    </div>
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros-20260521T142910Z-3-001/Livros/WhatsApp Image 2026-05-19 at 17.06.10 (3).jpeg" alt="Compañeros 3">
                        <span class="nivel-badge">Nível 3 — B1</span>
                        <h4>Compañeros 3</h4>
                        <p>Fluência em Desenvolvimento. Conversação espontânea e comunicação em diferentes contextos.</p>
                    </div>
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros-20260521T142910Z-3-001/Livros/WhatsApp Image 2026-05-19 at 17.06.10 (2).jpeg" alt="Compañeros 4">
                        <span class="nivel-badge">Nível 4 — A2.2</span>
                        <h4>Compañeros 4</h4>
                        <p>Comunicação Avançada. Fluência natural e segurança em contextos sociais e acadêmicos.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div style="display: grid; gap: 2rem;">
                    ...
                    <div class="level-card reveal">
                        ...
                        <div class="level-title">Primeiros Contatos com o Espanhol</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Os alunos desenvolvem vocabulário básico, compreensão oral inicial, pronúncia e comunicação simples, com interação em situações do cotidiano desde o primeiro dia.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Apresentações</span>
                            <span class="topic-tag">Família e Amigos</span>
                            <span class="topic-tag">Escola e Rotina</span>
                            <span class="topic-tag">Hobbies e Interesses</span>
                            <span class="topic-tag">Jogos e Atividades</span>
                        </div>
                    </div>

                    <div class="level-card reveal">
                        <div class="level-number">Nível 2 — A2</div>
                        <div class="level-title">Expansão da Comunicação</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Os alunos passam a construir diálogos mais completos, desenvolver maior confiança ao falar, melhorar a compreensão auditiva e aprender estruturas comunicativas do idioma.</p>
                        <div class="topic-tags">
                    ...
                    <div class="level-card reveal">
                        <div class="level-number">Nível 3 — B1</div>
                        <div class="level-title">Fluência em Desenvolvimento</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Os estudantes aprimoram a conversação espontânea, leitura e interpretação, escrita prática e comunicação em diferentes contextos sociais e culturais.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Opiniões e Debates</span>
                            <span class="topic-tag">Música e Cultura Latina</span>
                    ...
                    <div class="level-card reveal">
                        <div class="level-number">Nível 4 — B2</div>
                        <div class="level-title">Comunicação Avançada</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Os alunos desenvolvem fluência natural, segurança para se comunicar, interpretação cultural e uso mais sofisticado do idioma em contextos variados.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Cultura Internacional</span>
                            <span class="topic-tag">Viagens e Intercâmbios</span>
                            <span class="topic-tag">Projetos e Apresentações</span>
                            <span class="topic-tag">Comunicação Social</span>
                            <span class="topic-tag">Contextos Acadêmicos</span>
                        </div>
                    </div>
