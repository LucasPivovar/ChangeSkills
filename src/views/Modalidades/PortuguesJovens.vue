...
import { ArrowLeft, ArrowRight, Check, Smile, BookOpen, Users } from '@lucide/vue'
        ...
        <section class="hero-section">
            <div class="container hero-grid reveal active">
                <div style="text-align: left;">
                    <span style="color: var(--primary); font-weight: 800; letter-spacing: 0.2em; display: inline-block; margin-bottom: 1.5rem; text-transform: uppercase;">🇧🇷 Portuguese for Young Learners</span>
                    <h1 style="font-size: 4.2rem; margin-bottom: 2rem; line-height: 1.1; color: var(--primary-dark);">Portuguese for <span style="color: var(--primary);">Young Learners</span></h1>
                    <p style="font-size: 1.3rem; color: var(--primary-dark); font-weight: 600; margin-bottom: 1.5rem;">
                        Fun, Interactive, and Natural Language Development
                    </p>
                    <p style="font-size: 1.1rem; color: var(--gray); margin-bottom: 3rem; line-height: 1.8; max-width: 600px;">
                        Our young learners program is designed to help children and teenagers develop Portuguese naturally through interaction, conversation, games, storytelling, and contextual learning. The course is divided into two levels and uses the internationally recognized <strong>SAMBA!</strong> material, specifically developed for Portuguese learners in engaging and age-appropriate contexts.
                    </p>
                ...
                <div class="hero-image-container">
                    <img src="/assets/img/capa/PTBR TEEN.webp" alt="Portuguese for Young Learners — Change Skills">
                </div>
            </div>
        </section>
        ...
        <section style="background: #f8faff; padding: 100px 0;">
            <div class="container">
                <div class="reveal" style="margin-bottom: 5rem; text-align: left;">
                    ...
                    <h2 style="margin-top: 1rem; font-size: 3rem; color: var(--primary-dark);">Why Choose Our Program?</h2>
                    <p style="max-width: 800px; margin: 2rem 0; color: var(--gray); font-size: 1.15rem; line-height: 1.8;">
                        Our methodology prioritizes natural communication over memorization, helping students feel comfortable using Portuguese from the very beginning.
                    </p>
                </div>
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
                    <div class="feature-card reveal">
                        <Smile style="color: var(--primary); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.3rem; margin-bottom: 1rem;">Fun &amp; Engaging</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Interaction, conversation, games, storytelling, and contextual learning designed specifically for kids and teens.</p>
                    </div>
                    <div class="feature-card reveal">
                        <BookOpen style="color: var(--accent); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.3rem; margin-bottom: 1rem;">SAMBA! Material</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Internationally recognized material developed especially for Portuguese learners in engaging, age-appropriate contexts.</p>
                    </div>
                    <div class="feature-card reveal">
                        <Users style="color: var(--primary); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.3rem; margin-bottom: 1rem;">Brazilian Teachers</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Classes are fully personalized with native teachers, focused on active communication and cultural immersion.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section style="padding: 100px 0; background: white;" id="material">
            <div class="container reveal">
                <div style="text-align: left; margin-bottom: 5rem;">
                    ...
                    <h2 style="margin-top: 1rem; font-size: 3rem; color: var(--primary-dark);">SAMBA! Series</h2>
                    <p style="max-width: 900px; margin: 2rem 0; color: var(--gray); font-size: 1.15rem; line-height: 1.8;">
                        The SAMBA! series offers interactive activities, modern and engaging visuals, deep cultural immersion, communication-focused lessons, and age-appropriate learning experiences.
                    </p>
                </div>
                <div class="material-grid">
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros - Portuguese/Livros/WhatsApp Image 2026-05-19 at 17.04.43 (1).jpeg" alt="SAMBA! 1 - A1/A2">
                        <span class="nivel-badge">Level 1 — A1/A2</span>
                        <h4>SAMBA! Beginner</h4>
                        <p>Perfect foundation. Promotes pronunciation, speaking confidence, and basic vocabulary.</p>
                    </div>
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros - Portuguese/Livros/WhatsApp Image 2026-05-19 at 17.04.44.jpeg" alt="SAMBA! 2 - B1/B2">
                        <span class="nivel-badge">Level 2 — B1/B2</span>
                        <h4>SAMBA! Intermediate</h4>
                        <p>Expanding horizons. Promotes conversation fluency and practical Brazilian grammar.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section style="background: #f8faff; padding: 100px 0;">
            <div class="container">
                <div class="reveal" style="text-align: left; margin-bottom: 5rem;">
                    <span style="color: var(--primary); font-weight: 800; letter-spacing: 0.2em; text-transform: uppercase;">Structure</span>
                    <h2 style="margin-top: 1rem; font-size: 3rem; color: var(--primary-dark);">Program Structure</h2>
                </div>
                <div style="display: grid; gap: 2rem;">

                    <div class="level-card reveal">
                        <div class="level-number">Level 1</div>
                        <div class="level-title">Beginner Communication (A1-A2)</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Students develop a strong baseline in Portuguese through basic vocabulary, everyday communication, listening comprehension, pronunciation and speaking confidence, and an introduction to Brazilian culture.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Greetings and introductions</span>
                            <span class="topic-tag">Family and friends</span>
                            <span class="topic-tag">School and hobbies</span>
                            <span class="topic-tag">Colors, numbers, and routines</span>
                            <span class="topic-tag">Games and interactive activities</span>
                        </div>
                    </div>

                    <div class="level-card reveal" style="border-left-color: var(--primary);">
                        <div class="level-number" style="color: var(--primary);">Level 2</div>
                        <div class="level-title">Expanding Communication (B1-B2)</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Students continue developing conversational fluency, reading and listening comprehension, practical grammar through active communication, deep cultural understanding, and confidence in real-life conversations.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Daily routines</span>
                            <span class="topic-tag">Travel and leisure</span>
                            <span class="topic-tag">Food and restaurants</span>
                            <span class="topic-tag">Social interaction</span>
                            <span class="topic-tag">Brazilian traditions and celebrations</span>
                        </div>
                    </div>
