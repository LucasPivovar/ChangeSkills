...
import { ArrowLeft, ArrowRight, Check, Music, Ear, Globe } from '@lucide/vue'
        ...
        <section class="hero-section">
            <div class="container hero-grid reveal active">
                <div style="text-align: left;">
                    <span style="color: var(--primary); font-weight: 800; letter-spacing: 0.2em; display: inline-block; margin-bottom: 1.5rem; text-transform: uppercase;">🇫🇷 Français pour Enfants</span>
                    <h1 style="font-size: 4.5rem; margin-bottom: 2rem; line-height: 1.1; color: var(--primary-dark);">Francês para <span style="color: var(--primary);">Crianças</span></h1>
                    <p style="font-size: 1.3rem; color: var(--primary-dark); font-weight: 600; margin-bottom: 1.5rem;">
                        Aprendizado Divertido, Natural e Interativo!
                    </p>
                    <p style="font-size: 1.1rem; color: var(--gray); margin-bottom: 3rem; line-height: 1.8; max-width: 600px;">
                        Na <strong>Change Skills</strong>, as crianças descobrem o francês de forma leve e envolvente, com músicas, jogos, histórias e interação constante. Utilizamos o material <strong>Hourra!</strong> (Hachette), desenvolvido especialmente para crianças em processo inicial de aprendizagem do francês.
                    </p>
            ...
            <div class="container">
                <div class="reveal" style="margin-bottom: 5rem; text-align: left;">
                    ...
                    <p style="max-width: 800px; margin: 2rem 0; color: var(--gray); font-size: 1.15rem; line-height: 1.8;">
                        Nosso programa infantil foi criado para introduzir o francês de maneira leve e envolvente. A metodologia busca transformar o aprendizado em uma experiência divertida e significativa, com forte estímulo visual e auditivo.
                    </p>
                </div>
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
                    <div class="feature-card reveal">
                        <Music style="color: var(--primary); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.3rem; margin-bottom: 1rem;">Músicas e Jogos</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Aprendizado gamificado com atividades lúdicas que tornam o francês natural e divertido desde o início.</p>
                    </div>
                    <div class="feature-card reveal">
                        <Ear style="color: var(--accent); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.3rem; margin-bottom: 1rem;">Estímulo Auditivo</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Desenvolvimento natural da escuta e pronúncia com conteúdo apropriado e estimulante para crianças.</p>
                    </div>
                    <div class="feature-card reveal">
                        <Globe style="color: var(--primary); width: 40px; height: 40px; margin-bottom: 1.5rem;" class="info-icon" />
                        <h3 style="color: var(--primary-dark); font-size: 1.3rem; margin-bottom: 1rem;">Cultura Francesa</h3>
                        <p style="color: var(--gray); line-height: 1.6;">Integração entre língua e cultura francófona de forma adequada e encantadora para a faixa etária infantil.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section style="padding: 100px 0; background: white;">
            <div class="container reveal">
                <div style="text-align: left; margin-bottom: 5rem;">
                    ...
                    <h2 style="margin-top: 1rem; font-size: 3rem; color: var(--primary-dark);">Hourra! (Hachette)</h2>
                    <p style="max-width: 900px; margin: 2rem 0; color: var(--gray); font-size: 1.15rem; line-height: 1.8;">
                        A linha <strong>Hourra!</strong> oferece aprendizado lúdico e comunicativo, com forte estímulo visual e auditivo, conteúdo apropriado para crianças e desenvolvimento natural da linguagem. Integra cultura e comunicação de forma encantadora.
                    </p>
                </div>
                <div class="material-grid">
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros - Frances/Livros/WhatsApp Image 2026-05-19 at 17.55.08 (4).jpeg" alt="Hourra! Nível 1">
                        <span class="nivel-badge">Nível 1</span>
                        <h4>Hourra! — Premiers Pas</h4>
                        <p>Primeiros contatos com o idioma. Vocabulário básico, cores, números, família e brincadeiras.</p>
                    </div>
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros - Frances/Livros/WhatsApp Image 2026-05-19 at 17.55.08 (1).jpeg" alt="Hourra! Nível 2">
                        <span class="nivel-badge">Nível 2</span>
                        <h4>Hourra! — Communication</h4>
                        <p>Pequenas frases e interação simples. Jogos, projetos e cultura francesa infantil.</p>
                    </div>
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros - Frances/Livros/WhatsApp Image 2026-05-19 at 17.55.08 (3).jpeg" alt="Hourra! Nível 3">
                        <span class="nivel-badge">Nível 3</span>
                        <h4>Hourra! — Expression</h4>
                        <p>Conversação espontânea, pequenos diálogos e leitura inicial com segurança.</p>
                    </div>
                    <div class="material-item reveal">
                        <img src="/assets/img/Livros - Frances/Livros/WhatsApp Image 2026-05-19 at 17.55.08 (2).jpeg" alt="Hourra! Nível 4">
                        <span class="nivel-badge">Nível 4</span>
                        <h4>Hourra! — Autonomie</h4>
                        <p>Fluência infantil e comunicação natural. Projetos e cultura francófona.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div style="display: grid; gap: 2rem;">
                    ...
                    <div class="level-card reveal">
                        ...
                        <div class="level-title">Premiers Pas en Français</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">As crianças desenvolvem os primeiros contatos com o idioma, vocabulário básico, escuta e pronúncia inicial e comunicação simples e divertida.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Cores e Números</span>
                            <span class="topic-tag">Família</span>
                            <span class="topic-tag">Animais</span>
                            <span class="topic-tag">Escola</span>
                            <span class="topic-tag">Brincadeiras e Músicas</span>
                        </div>
                    </div>

                    <div class="level-card reveal">
                        <div class="level-number">Nível 2</div>
                        <div class="level-title">Communication et Découverte</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Os alunos passam a compreender pequenas frases, interagir em situações simples, desenvolver maior compreensão oral e aprender por meio de jogos e projetos.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Rotina</span>
                            <span class="topic-tag">Hobbies</span>
                            <span class="topic-tag">Alimentação</span>
                            <span class="topic-tag">Amigos</span>
                            <span class="topic-tag">Cultura Francesa Infantil</span>
                        </div>
                    </div>

                    <div class="level-card reveal">
                        <div class="level-number">Nível 3</div>
                        <div class="level-title">Expression et Confiance</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Os estudantes desenvolvem conversação mais espontânea, pequenos diálogos, leitura inicial e maior segurança ao falar em francês.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Viagens</span>
                            <span class="topic-tag">Esportes</span>
                            <span class="topic-tag">Histórias e Aventuras</span>
                            <span class="topic-tag">Cultura e Celebrações</span>
                            <span class="topic-tag">Experiências Cotidianas</span>
                        </div>
                    </div>

                    <div class="level-card reveal">
                        <div class="level-number">Nível 4</div>
                        <div class="level-title">Communication Naturelle</div>
                        <p style="color: var(--gray); line-height: 1.7; margin-bottom: 1rem;">Os alunos aprimoram a fluência infantil, comunicação natural, interpretação oral, criatividade e autonomia no idioma.</p>
                        <div class="topic-tags">
                            <span class="topic-tag">Projetos Interativos</span>
                            <span class="topic-tag">Cultura Francófona</span>
                            <span class="topic-tag">Conversas do Dia a Dia</span>
                            <span class="topic-tag">Situações Reais</span>
                            <span class="topic-tag">Autonomia no Idioma</span>
                        </div>
                    </div>
